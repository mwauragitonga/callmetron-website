	...
	<div class="container-fluid">
		<div class="row no-padding justify-content-center d-flex align-items-center">
			...
			<div class="col-lg-6 about-right no-padding relative">
				<div class="overlay overlay-bg"></div>
				<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn">	<img class="play" src="<?php echo base_url(); ?>assets/img/play-btn.png" alt="">
				</a>
				<img class="main img-fluid" src="<?php echo base_url(); ?>assets/img/video-bg.jpg" alt="">
			</div>
		</div>
	</div>
</section>
