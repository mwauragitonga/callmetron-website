...
<head>
	...
	<!-- Meta Keyword -->
	<meta name="keywords" content="Call Manager| Call Logger | Reports">
	<!-- meta character set -->
	<meta charset="UTF-8">
	<!-- Site Title -->
...
<header id="header" id="home">
	<div class="container">
		<div class="row align-items-center justify-content-between d-flex">
			<div id="logo">
				<a href="<?php echo base_url(); ?>home "><img src="<?php echo base_url(); ?>assets/img/logo.jpg" alt="" title="" /></a>
			</div>
			<nav id="nav-menu-container">
				<ul class="nav-menu">
					<li class="menu-active"><a href="<?php echo base_url(); ?>home">Home</a></li>
					<li><a href="<?php echo base_url(); ?>features">Features</a></li>
					<li><button><a href="<?php echo base_url(); ?>partner">Partners</a></li></button>
